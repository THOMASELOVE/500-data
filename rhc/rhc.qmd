...
I am only including some of the options I used to include here, owing to some problems with the **rbounds** package. I have a note in to the developer of **rbounds** and will update here when I have a solution.
...
match3 <- Match(Y = Y, Tr = Tr, X = X, estimand = "ATT", 
                 Weight.matrix = genout3)
psens(match3$index.treated, match3$index.control,
      Gamma = 1.5, GammaInc = 0.1)
```
